...
function AddOffers(){
    ...
    return(<div>
        <h1 className="alert text-center m-3">Add New Offer</h1>
        <form className="col-4 mx-auto" onSubmit={handleSubmit}>
            ...
            <div style={{margin:30}}>
                <label className="form-label" style={{float:"left"}}>Price After Offer</label>
                <input type="number" name="price2" className="form-control" onChange={handleChange}/>
            </div>
            <div style={{margin:30}}>
